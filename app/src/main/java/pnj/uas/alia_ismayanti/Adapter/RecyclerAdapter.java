package pnj.uas.alia_ismayanti.Adapter;
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<Dokter> uploads) {
        mContext = context;
        dokter = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        Dokter currentDokter = dokter.get(position);
        holder.nameTextView.setText(currentDokter.getName());
        holder.descriptionTextView.setText(currentDokter.getDescription());
        holder.dateTextView.setText(getDateToday());
        Picasso.with(mContext)
                .load(currentDokter.getGambarUrl())
